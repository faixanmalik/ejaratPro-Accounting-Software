    ...
    const setPassword = async (e) => {
        ...
        if( npassword !== cnpassword ){
          ...
          let response = await res.json()    
            ...
            if (response.success === true) {
              toast.success("Your Password has been changes successfully" , { position: "top-right", autoClose: 1000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, theme: "light", });
            }
            else {
   ...
   <ToastContainer position="top-right" autoClose={1000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable pauseOnHover theme="light"/>
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
            <h1 className="text-center text-2xl font-bold text-indigo-700 mb-5">EjaratPro</h1>  
            ...
            <div className="py-3">
                ...
                <div className="text-center sm:text-left whitespace-nowrap">
                    <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                        ...
                        <span className="inline-block ml-1"><Link href={"/"}>Back to EjaratPro</Link></span>
                    </button>
                </div>
                </div>
            </div>
