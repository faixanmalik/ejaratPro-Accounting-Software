  ...
  <>
    ...
    <div className='my-14 lg:my-20'>
      <div className='flex justify-center'>
        <Card className="w-[95%] md:w-10/12 xl:w-9/12">
          ...
          <div className='flex'>
            ...
            <div className='hidden rounded-r-xl w-full bg-gradient-to-r from-blue-500 to-blue-900 lg:flex justify-center text-white rounded-l-[8rem]'>
